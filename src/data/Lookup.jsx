...
export default {
  ...
  SIGNIN_HEADING: 'Continue With Volt.New 2.0',
  SIGNIN_SUBHEADING: 'To use Volt you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using Volt, you agree to the collection of usage data for analytics.',
